...
class Ansel_Widget_Links extends Ansel_Widget_Base
{
    ...
    public function html()
    {
        ...
        $view->userfeedurl = Ansel::getUrlFor('rss_user', ['owner' => $view->owner]);
        $view->slug = $this->_view->gallery->get('slug');
        $view->galleryname = $this->_view->gallery->get('name');
        $view->galleryfeedurl = Ansel::getUrlFor('rss_gallery', ['gallery' => $this->_view->gallery->id, 'slug' => $view->slug]);
        $view->title = _("Links");
