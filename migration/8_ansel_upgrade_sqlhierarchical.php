...
class AnselUpgradeSqlHierarchical extends Horde_Db_Migration_Base
{
    ...
    public function up()
    {
        ...
        try {
            $this->removeIndex('ansel_shares', ['name' => 'ansel_shares_share_parents_idx']);
        } catch (Exception $e) {
        }
        $this->addColumn('ansel_shares', 'share_name', 'string', ['limit' => 255, 'null' => false, 'default' => '']);
        ...
        foreach ($ids as $id) {
            $params = [strval(new Horde_Support_Randomid()), $id];
    ...
    public function down()
    {
        ...
        $this->changeColumn('ansel_shares', 'share_parents', 'string', ['limit' => 255]);
